const Footer = () => {
    return (
        ...
        <img className="rounded-2xl" style={{ height: '100%', width: '100%', objectFit: 'cover' }} src="6-resep-steak-daging-sapi-lezat-ala-restoran-empuk-bikin-nagih.jpg" />
      </div>

      <div className="grid grid-cols-2 gap-2 mx-auto w-4/5 my-5 text-left">
        <div>
          <section className='mb-4'>
            <h1 className="font-bold text-4xl">Steak</h1>
          </section>
          <section className='mb-4'>
            <h2 className="font-bold text-4xl text-[#393E72]">$7</h2>
          </section>
        </div>
